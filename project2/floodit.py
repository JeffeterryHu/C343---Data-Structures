...
import flood1.flood
# from flood_array import flood1
...
def initialize(board_size, color_of_tile, flooded_list, screen_size):
    ...
    flood1(color_of_tile, flooded_list, screen_size)
...
In this mode, the user acts as a gamer, trying to flood1 the board within the alloted moves
