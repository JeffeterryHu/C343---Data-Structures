...
k = Knight(4,4)
for p in k:
 test( k.position.distance(p) == math.sqrt(5) )
...
Circle.pi = math.pi
test( c1.pi == 3.141592653589793 and c2.pi == 3.141592653589793 )
c1.pi = 3.14159
test( c1.pi == 3.14159 and c2.pi == 3.141592653589793 and Circle.pi == 3.141592653589793 )
#-------------------------------------------------------------------------------
